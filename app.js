...
router.get('/get/html', function(req, res) {
    ...
    var xml = fs.readFileSync('MovieList.xml', 'utf8'); //We are reading in the XML file
    var xsl = fs.readFileSync('MovieList.xsl', 'utf8'); //We are reading in the XSL file
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    xmlFileToJs('MovieList.xml', function(err, result) {
      if (err) throw (err);
      ...
      result.movielist.section[obj.sec_n].movie.push({'item': obj.item, 'price': obj.price}); //If your XML elements are differet, this is where you have to change to your own element names
      //Converting back to our original XML file from JSON
      jsToXmlFile('MovieList.xml', result, function(err) {
...
router.post('/post/delete', function(req, res) {
  ...
  function deleteJSON(obj) {
    ...
    xmlFileToJs('MovieList.xml', function(err, result) {
      ...
      delete result.movielist.section[obj.section].movie[obj.entree];
